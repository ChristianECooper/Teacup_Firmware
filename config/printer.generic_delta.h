...
/** \def KINEMATICS_STRAIGHT KINEMATICS_COREXY
  ...
  KINEMATICS_DELTA
    A bot using delta geometry - Rostock or Kossel like.
*/
...
#define DEFAULT_DELTA_DIAGONAL_ROD_SQR (DEFAULT_DELTA_DIAGONAL_ROD * DEFAULT_DELTA_DIAGONAL_ROD) // take care! This is 64bit!
